 ...
 */
 ...
 /* 
 All primitive datatypes uses stack memory for storing data.
 All Non-primitive datatypes uses heap memory for storing data.
*/
...
console.log(userOne); // stored in stack and passed by value
console.log(userTwo);
...
console.log(objOne.Age); // stored in heap and passed by reference
